...
public:
    CMainParams() {
        ...
        //add 1 to the start message for Larry 1.0.1 so we dont talk to old wallets, and change the default port's
        ...
        const char* pszTimestamp = "In Style September 2nd 2017";
        CTransaction txNew;
        txNew.nTime = 1504304746;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
