...
memory available when compiling LarryCoin Core. With 512MB of memory or less
...
If you want to build Larry-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a Larry-qt executable will be
built by default.
